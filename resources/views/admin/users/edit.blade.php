...
<div class="container">
    ...
    <form method="post" action="{{ route('admin.books.edit', $book) }}">
        ...
        <div class="mb-3">
            ...
            <input type="url" class="form-control @error('cover_url') is-invalid @enderror" id="inputCoverUrl" name="cover_url" value="{{ old('cover_url', $book->cover_url) }}" aria-describedby="coverUrlHelp">
